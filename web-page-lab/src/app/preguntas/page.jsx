    ...
    return(
        ...
        <div className='grid grid-cols-1 p-6 gap-25'>
            <div className="p-4  flex flex-col justify-between items-center bg-gradient-to-r from-blue-950 via-sky-900 to-stone-500/10">
                <p className="text-3xl p-4 justify-self-start self-start mx-40 py-10 max-md:mx-0">¿Cómo puedo unirme como investigador posdoctoral?</p>
                <div className="pb-10 self-start mx-50 max-md:mx-0">
            ...
            <p className="text-3xl p-4 justify-self-start self-end mx-50 py-10 max-md:mx-0"> ¿Qué áreas de investigación cubre el laboratorio?</p>
                <div className="pb-10 self-end mx-50 max-md:mx-0">
            ...
            <div className="p-4  flex flex-col justify-between items-center  bg-gradient-to-r from-blue-950 via-sky-900 to-stone-500/10">
                <p className="text-3xl p-4 justify-self-start self-start mx-40 py-10 max-md:mx-0">¿Puedo proponer un tema para mi tesis o proyecto terminal?</p>
                <div className="pb-10 self-start mx-50 max-md:mx-0">
            ...
            <p className="text-3xl p-4 justify-self-start self-end mx-50 py-10 max-md:mx-0"> ¿Aceptan estudiantes para servicio social o prácticas profesionales?</p>
                <div className="pb-10 self-end mx-50 max-md:mx-0">
